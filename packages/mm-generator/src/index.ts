    ...
    Object.values(schema.modules)
      ...
      .map((module) => {
        ...
        return [
          ...
          `// THIS FILE IS AUTOGENERATED BY MM-GENERATOR. DO NOT MODIFY IT MANUALLY.

#import "${module.moduleName}.h"
// 1. Import the Swift header
#import "${swiftHeader}"

@implementation ${module.moduleName}{
  // 2. Declare a pointer to the Swift implementation
...
- (instancetype)init {
  // 3. Initialize the pointer to the Swift implementation
...
// 4. Implement the methods from the codegen spec and call the Swift implementation
# pragma mark - Methods
